...
plating=1
culture=3
timeIntervalList2=[0.01,0.05,0.1,0.2,0.5,1,2,3,4,5,6,7,8,10,20,50,100,200,300,500]
timeIntervalList2=[0.2,0.5,1,2,3]
timeIntervalList=timeIntervalList2[::-1]
cvList=[]
...
for timeInterval in timeIntervalList:
    ...
    if sum(frequencies)>1:
        ...
        ## Add to file
        cvpath=dirname+"/cvList.txt"
        #open text file
        text_file = open(cvpath, "a")
        
        #write string to file
        text_file.write(str(cv))
